...
class UsersHiddenInterface(Interface):
    ...
    def get(self, section, type=None, page=None, per_page=None, **kwargs):
        ...
        response = self.http.get(f'/users/hidden/{section}',
    ...
    def add(self, section, items, **kwargs):
        ...
        response = self.http.post(f'/users/hidden/{section}', data=items,
    ...
    def remove(self, section, items, **kwargs):
        ...
        response = self.http.post(f'/users/hidden/{section}/remove', data=items,
                                  **dictfilter(kwargs, pop=['authenticated', 'validate_token']))
